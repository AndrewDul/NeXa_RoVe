import{j as r}from"./jsx-runtime.D_zvdyIk.js";import{r as d}from"./index.DBy5LfQW.js";const T="modulepreload",R=function(t){return"/NeXa_RoVe/"+t},N={},S=function(e,o,c){let a=Promise.resolve();if(o&&o.length>0){let p=function(h){return Promise.all(h.map(m=>Promise.resolve(m).then(x=>({status:"fulfilled",value:x}),x=>({status:"rejected",reason:x}))))};document.getElementsByTagName("link");const u=document.querySelector("meta[property=csp-nonce]"),g=u?.nonce||u?.getAttribute("nonce");a=p(o.map(h=>{if(h=R(h),h in N)return;N[h]=!0;const m=h.endsWith(".css"),x=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${h}"]${x}`))return;const f=document.createElement("link");if(f.rel=m?"stylesheet":T,m||(f.as="script"),f.crossOrigin="",f.href=h,g&&f.setAttribute("nonce",g),document.head.appendChild(f),m)return new Promise((k,M)=>{f.addEventListener("load",k),f.addEventListener("error",()=>M(new Error(`Unable to preload CSS for ${h}`)))})}))}function i(p){const u=new Event("vite:preloadError",{cancelable:!0});if(u.payload=p,window.dispatchEvent(u),!u.defaultPrevented)throw p}return a.then(p=>{for(const u of p||[])u.status==="rejected"&&i(u.reason);return e().catch(i)})};let O;function L(){return O??=S(()=>import("./index.Bvu9zNsI.js"),[]).then(t=>t.gsap),O}function j(t,e){if(e)return;const o=t.querySelector(".face-inner"),c=t.querySelector(".face-core");L().then(a=>{a.timeline().fromTo(o,{scaleY:.9,y:9,transformOrigin:"180px 180px"},{scaleY:1,y:0,duration:.58,ease:"elastic.out(1, 0.38)"}).fromTo(c,{scale:.985,transformOrigin:"180px 180px"},{scale:1,duration:.52,ease:"elastic.out(1, 0.5)"},0)})}function X(t,e){t.length!==0&&L().then(o=>{o.fromTo(t,{scaleY:1,transformOrigin:"50% 50%"},{scaleY:.08,duration:.08,yoyo:!0,repeat:1,ease:"power1.inOut"})})}function y(t,e,o){if(t.length===0)return;const c=e==="left"?-7:e==="right"?7:0;if(o){t.forEach(a=>{(a instanceof HTMLElement||a instanceof SVGElement)&&(a.style.transform=`translateX(${c}px)`)});return}L().then(a=>{a.to(t,{x:c,duration:.48,ease:"power3.out"})})}let A;function z(){return A??=S(()=>import("./index.Bvu9zNsI.js"),[]).then(t=>t.gsap),A}function F(t,e){const o=Array.from(t.querySelectorAll("[data-launcher-tile]"));if(e)return t.style.opacity="1",o.forEach(i=>{i instanceof HTMLElement&&(i.style.opacity="1",i.style.filter="none")}),()=>{};let c=!1,a;return z().then(i=>{c||(a=i.timeline(),a.fromTo(t,{opacity:0},{opacity:1,duration:.18,ease:"power1.out"}),a.fromTo(o,{opacity:0,filter:"blur(8px)"},{opacity:1,filter:"blur(0px)",duration:.46,stagger:.045,ease:"power3.out"},.04))}),()=>{c=!0,a?.kill()}}function $(t){const e=Array.from(document.querySelectorAll("[data-scroll-section]")),o=()=>{document.body.classList.toggle("face-docked",window.scrollY>Math.max(260,window.innerHeight*.55))};if(o(),window.addEventListener("scroll",o,{passive:!0}),t||!("IntersectionObserver"in window))return e.forEach(a=>a.classList.add("section-visible")),()=>window.removeEventListener("scroll",o);const c=new IntersectionObserver(a=>{for(const i of a)i.isIntersecting&&(i.target.classList.add("section-visible"),c.unobserve(i.target))},{threshold:.14});return e.forEach(a=>c.observe(a)),()=>{c.disconnect(),window.removeEventListener("scroll",o)}}const B={"face-click":"pressed",blink:"sleepy","look-left":"look-left","look-right":"look-right",smile:"smile",focus:"focused",surprise:"surprised",laugh:"laugh",squint:"squint",sleepy:"sleepy","press-release":"neutral"},P={state:"neutral",launcherOpen:!1,reducedMotion:!1};function v(t,e,o={}){const c=o.reducedMotion??t.reducedMotion,a={...t,reducedMotion:c,lastEvent:e};return e==="reduced-motion-on"?{...a,state:"neutral",reducedMotion:!0}:e==="reduced-motion-off"?{...a,reducedMotion:!1}:e==="launcher-open"?{...a,state:"smile",launcherOpen:!0}:e==="launcher-close"?{...a,state:"neutral",launcherOpen:!1}:c&&["blink","look-left","look-right"].includes(e)?{...a,state:"neutral"}:{...a,state:B[e]??t.state}}function Y({open:t,tiles:e,onTileHover:o,onTileSelect:c}){return r.jsx("nav",{className:"system-launcher","data-open":t?"true":"false","aria-label":"NeXa system launcher","aria-hidden":!t,children:r.jsx("div",{className:"launcher-grid",children:e.map(a=>a.active?r.jsx("a",{className:"launcher-tile launcher-tile-active","data-launcher-tile":!0,"data-launcher-active":"true",href:a.href,"aria-label":`${a.label}: ${a.summary}`,"data-category":a.category,onClick:i=>c(a,i),onFocus:()=>o(a.reaction),onMouseEnter:()=>o(a.reaction),tabIndex:t?0:-1,children:r.jsx(C,{tile:a})},a.id):r.jsx("button",{className:"launcher-tile launcher-tile-placeholder","data-launcher-tile":!0,"data-launcher-active":"false",type:"button","aria-label":`${a.label}: Coming soon`,"aria-disabled":"true","data-category":a.category,onClick:i=>c(a,i),onMouseEnter:()=>o(a.reaction),tabIndex:-1,children:r.jsx(C,{tile:a})},a.id))})})}function C({tile:t}){return r.jsxs(r.Fragment,{children:[r.jsx("span",{className:"launcher-icon","aria-hidden":"true",children:r.jsx(q,{iconKey:t.iconKey})}),r.jsxs("span",{className:"launcher-copy",children:[r.jsx("strong",{children:t.label}),r.jsx("small",{children:t.summary})]}),r.jsx("span",{className:"launcher-category",children:t.category})]})}function q({iconKey:t}){return t==="prototype"?r.jsxs("svg",{viewBox:"0 0 24 24",focusable:"false",children:[r.jsx("rect",{x:"6",y:"7",width:"12",height:"9",rx:"3"}),r.jsx("path",{d:"M9 17h6M8 7V4m8 3V4"}),r.jsx("circle",{cx:"10",cy:"11.5",r:"1.2"}),r.jsx("circle",{cx:"14",cy:"11.5",r:"1.2"})]}):t==="hardware"?r.jsxs("svg",{viewBox:"0 0 24 24",focusable:"false",children:[r.jsx("rect",{x:"7",y:"7",width:"10",height:"10",rx:"2"}),r.jsx("path",{d:"M4 9h3m-3 6h3m10-6h3m-3 6h3M9 4v3m6-3v3M9 17v3m6-3v3"})]}):t==="story"?r.jsxs("svg",{viewBox:"0 0 24 24",focusable:"false",children:[r.jsx("path",{d:"M6 6h12M6 12h10M6 18h7"}),r.jsx("circle",{cx:"5",cy:"6",r:"1"}),r.jsx("circle",{cx:"5",cy:"12",r:"1"}),r.jsx("circle",{cx:"5",cy:"18",r:"1"})]}):t==="code"?r.jsx("svg",{viewBox:"0 0 24 24",focusable:"false",children:r.jsx("path",{d:"m9 8-4 4 4 4m6-8 4 4-4 4M13 6l-2 12"})}):t==="demo"?r.jsxs("svg",{viewBox:"0 0 24 24",focusable:"false",children:[r.jsx("circle",{cx:"12",cy:"12",r:"8"}),r.jsx("path",{d:"m10.5 8.5 5 3.5-5 3.5z"})]}):t==="roadmap"?r.jsxs("svg",{viewBox:"0 0 24 24",focusable:"false",children:[r.jsx("path",{d:"M5 18c3-8 8 1 11-7l2-5M15 6h3v3"}),r.jsx("circle",{cx:"5",cy:"18",r:"1.5"}),r.jsx("circle",{cx:"12",cy:"14",r:"1.5"})]}):t==="boundary"?r.jsxs("svg",{viewBox:"0 0 24 24",focusable:"false",children:[r.jsx("path",{d:"M12 4 5 7v5c0 4 2.8 6.7 7 8 4.2-1.3 7-4 7-8V7z"}),r.jsx("path",{d:"M9 12h6"})]}):r.jsxs("svg",{viewBox:"0 0 24 24",focusable:"false",children:[r.jsx("circle",{cx:"12",cy:"12",r:"7"}),r.jsx("path",{d:"M12 5v14M5 12h14"})]})}const D=2,V=1,H=!1,U=!1,G=242,W="The canonical NeXa face is the NeXa logo identity: two white vertical bean-shaped eyes and one medium-thick curved smile line drawn directly on the dark background.";function J(){return typeof window<"u"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}function te({tiles:t}){const[e,o]=d.useState(P),[c,a]=d.useState(!1),i=d.useRef(null),p=d.useRef(null),u=d.useRef(null),g=d.useRef(void 0),h=d.useMemo(()=>`face-svg face-${e.state} ${e.launcherOpen?"face-launcher-open":""}`,[e.state,e.launcherOpen]);d.useEffect(()=>{const n=J();o(b=>({...b,reducedMotion:n}));const s=$(n);window.location.hash&&window.location.hash!=="#top"&&(document.body.classList.add("content-active","face-docked"),a(!0),E());const l=window.matchMedia("(prefers-reduced-motion: reduce)"),w=()=>{o(b=>v(b,l.matches?"reduced-motion-on":"reduced-motion-off",{reducedMotion:l.matches}))};return l.addEventListener("change",w),()=>{s(),l.removeEventListener("change",w)}},[]),d.useEffect(()=>{if(!c){document.body.classList.remove("flow-bar-docked");return}E();const n=()=>E();return window.addEventListener("scroll",n,{passive:!0}),window.addEventListener("resize",n),()=>{window.removeEventListener("scroll",n),window.removeEventListener("resize",n)}},[c]),d.useEffect(()=>{const n=s=>{const l=s.target;!(l instanceof Element)||!l.closest("[data-nexa-return-home]")||(s.preventDefault(),i.current&&j(i.current,e.reducedMotion),f())};return document.addEventListener("click",n),()=>document.removeEventListener("click",n)},[e.reducedMotion]),d.useEffect(()=>{if(!e.launcherOpen)return;const n=s=>{s.key==="Escape"&&(s.preventDefault(),x(!0))};return window.addEventListener("keydown",n),()=>window.removeEventListener("keydown",n)},[e.launcherOpen]),d.useEffect(()=>{if(!(!e.launcherOpen||!p.current))return F(p.current,e.reducedMotion)},[e.launcherOpen,e.reducedMotion]),d.useEffect(()=>{if(e.reducedMotion)return;const n=Array.from(i.current?.querySelectorAll("[data-eye]")??[]),s=Array.from(i.current?.querySelectorAll("[data-face-logo-part]")??[]);let l,w;const b=window.setTimeout(()=>{l=window.setInterval(()=>X(n),9800),w=window.setInterval(()=>{const I=Math.random()>.5?"left":"right";y(s,I,!1),window.setTimeout(()=>y(s,"center",!1),1200)},24e3)},3200);return()=>{window.clearTimeout(b),l&&window.clearInterval(l),w&&window.clearInterval(w)}},[e.reducedMotion]),d.useEffect(()=>{const n=Array.from(i.current?.querySelectorAll("[data-face-logo-part]")??[]);e.state==="look-left"&&y(n,"left",e.reducedMotion),e.state==="look-right"&&y(n,"right",e.reducedMotion),(e.state==="neutral"||e.state==="smile")&&y(n,"center",e.reducedMotion)},[e.state,e.reducedMotion]);function m(n,s=!0){o(l=>v(l,n,{reducedMotion:l.reducedMotion})),s&&(window.clearTimeout(g.current),g.current=window.setTimeout(()=>{o(l=>v(l,l.launcherOpen?"launcher-open":"press-release"))},900))}function x(n=!1){window.clearTimeout(g.current),o(s=>v(s,"launcher-close")),n&&window.setTimeout(()=>u.current?.focus(),0)}function f(){window.clearTimeout(g.current),x(!1),document.body.classList.remove("content-active","face-docked","flow-bar-docked"),a(!1),window.history.replaceState(null,"",`${window.location.pathname}${window.location.search}`),window.scrollTo({top:0,behavior:e.reducedMotion?"auto":"smooth"}),o(n=>v({...n,launcherOpen:!1},"press-release"))}function k(){if(c||document.body.classList.contains("content-active")){i.current&&j(i.current,e.reducedMotion),f();return}if(!!e.launcherOpen){x();return}i.current&&j(i.current,e.reducedMotion),o(s=>v(s,"face-click")),window.setTimeout(()=>{o(s=>v(s,"launcher-open"))},e.reducedMotion?0:160)}function M(n){m(n)}function _(n,s){if(s.preventDefault(),!n.active){m(n.reaction);return}m("smile",!1),x(!1),document.body.classList.add("content-active","face-docked"),document.body.classList.remove("flow-bar-docked"),a(!0),window.setTimeout(()=>{const l=document.getElementById(n.targetId);l&&(window.history.replaceState(null,"",`#${n.targetId}`),l.scrollIntoView({behavior:e.reducedMotion?"auto":"smooth",block:"start"}))},e.reducedMotion?0:120)}return r.jsxs("div",{className:"nexa-system","data-launcher-open":e.launcherOpen?"true":"false",ref:i,children:[r.jsx("button",{ref:u,className:`face-control ${e.launcherOpen?"face-control-open":""} ${c?"face-control-docked":""}`,type:"button","aria-expanded":e.launcherOpen,"aria-controls":"nexa-launcher","aria-label":c?"Return to NeXa home":e.launcherOpen?"Close NeXa system launcher":"Open NeXa system launcher",title:c?"Return home":void 0,"data-testid":"nexa-face-control",onClick:k,children:r.jsxs("svg",{className:h,viewBox:"0 0 360 360",role:"img","aria-labelledby":"nexa-face-title","data-testid":"nexa-face-logo",children:[r.jsx("title",{id:"nexa-face-title",children:"Animated NeXa face"}),r.jsx("desc",{children:W}),r.jsxs("g",{className:"face-inner face-core","data-testid":"nexa-face-core","data-face-role":"canonical","data-canonical-eye-count":D,"data-canonical-smile-count":V,"data-canonical-has-frame":H,"data-canonical-has-border":U,"data-canonical-min-smile-y":G,children:[r.jsx("rect",{"data-eye":!0,"data-testid":"nexa-face-eye","data-face-logo-part":!0,className:"eye eye-left",x:"108",y:"70",width:"46",height:"128",rx:"23"}),r.jsx("rect",{"data-eye":!0,"data-testid":"nexa-face-eye","data-face-logo-part":!0,className:"eye eye-right",x:"206",y:"70",width:"46",height:"128",rx:"23"}),r.jsx("path",{"data-testid":"nexa-face-smile","data-face-logo-part":!0,className:"smile-mark",d:Q(e.state)})]})]})}),r.jsx("div",{id:"nexa-launcher",ref:p,children:r.jsx(Y,{open:e.launcherOpen,tiles:t,onTileHover:M,onTileSelect:_})}),r.jsx("style",{children:Z})]})}function E(){const t=window.scrollY>Math.max(180,window.innerHeight*.28);document.body.classList.toggle("flow-bar-docked",t)}function Q(t){return t==="focused"||t==="squint"||t==="sleepy"?"M118 258 C148 282, 212 282, 242 258":t==="laugh"||t==="smile"||t==="surprised"?"M110 248 C142 306, 218 306, 250 248":"M112 256 C144 296, 216 296, 248 256"}const Z=`
  .nexa-system {
    position: relative;
    display: grid;
